...
class FollowersAdapter(private var list: ArrayList<User>) :
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val dataFollowers = list[position]
        holder.txtName.text = dataFollowers.name
        holder.txtCompany.text = dataFollowers.company
